...
if (isset($_GET['delete'])) {
    ...
    $create = mysqli_query($ketnoi, "DELETE FROM `website` WHERE `id` = '" . $delete . "' ");

    if ($create) {
        echo '<script type="text/javascript">swal("Thành Công","Xóa thành công","success");setTimeout(function(){ location.href = "website.php" },500);</script>';
    } else {
        echo '<script type="text/javascript">swal("Lỗi","Lỗi máy chủ","error");setTimeout(function(){ location.href = "website.php" },1000);</script>';
    }
}
?>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="datatable1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $result = mysqli_query($ketnoi, "SELECT * FROM `website` ORDER BY id asc ");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="website.php?delete=<?= $row['id']; ?>" class="btn btn-default">
            ...
            <div class="modal-body">
                <form role="form" action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="domain" placeholder="Nhập Tên Miền" required="">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">DỊCH VỤ CUNG CẤP</label>
                        <input type="text" class="form-control" name="provide" placeholder="Nhập Dịch vụ cung cấp" required="">
                    </div>
                    <div class="form-group">
...
if (isset($_POST["submit"])) {
    $create = mysqli_query($ketnoi, "INSERT INTO `website` SET 
    `domain` = '" . $_POST['domain'] . "',
    `link` = '" . $_POST['link'] . "',
